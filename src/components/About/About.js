    ...
    <div className="about">
      <div>
        ...
        <p>
          ...
          "ugly" looking websites and was very proud of it, untill I started on
          CSS. Then it quickly become a challenge. I started looking for "free"
          online courses, and found
          ...
          completed their courses. My next source was youtube. I started to dive
          deep into javascript, learned react-js and node-js.
        </p>
        <h3>Besides coding:</h3>
        <p>
          I like video games and movies. and who doesn't love musics. I want to
          travel a lot before I take my last breath, but I haven't started it
