      ...
      <div className="works">
        ...
        <div className="work-item">
          ...
          <p>
            ...
            obviously :p) Send money to other users with their "wallet address"
            Features I would like to add; Notification when received money
            Message when sending money Add user image on sign in Edit user
            details ...
          </p>
        ...
        <div className="work-item">
          ...
          <p>
            ...
            details ( google maps api throws 'request limit reached ' error :p).
            So, now this app only shows weather for your current location. (That
            too is not accurate :( ) Also it has a problem with getting
            geolocation of some mobile devices.
          </p>
        ...
        <div className="work-item">
          ...
          <img src={RockPaper} alt="rock paper scissor made with javascript" />
          <a
            rel="noopener noreferrer"
